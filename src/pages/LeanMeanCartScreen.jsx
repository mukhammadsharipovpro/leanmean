...
import LeanMeanCartItemComponent from '../components/LeanMeanCartItemComponent';
import LeanMeanComponent from '../components/LeanMeanComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <LeanMeanCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
